...
class CanvasTxt {
  ...
  constructor(txt: string, { fontSize = 200, fontFamily = 'Arial', color = '#ffffff' }: CanvasTxtOptions = {}) {
    this.canvas = document.createElement('canvas');
    this.context = this.canvas.getContext('2d');
    this.txt = txt;
    ...
    >
      <style>{`
        ...
        .ascii-text-container pre {
          ...
          top: 0;
          pointer-events: none;
          background-image: radial-gradient(circle, #ff2a2a 0%, #b30000 50%, #660000 100%);
