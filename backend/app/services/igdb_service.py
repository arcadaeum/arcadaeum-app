...
class IGDBService:
    ...
    def fetch_top_games(self, limit: int = 500) -> list[dict[str, Any]]:
        ...
        query = f"""
        fields id, name, summary, involved_companies.company.name, involved_companies.developer, cover.image_id, artworks.image_id, screenshots.image_id, platforms.name, genres.name, first_release_date, total_rating;
    ...
    def fetch_game_by_id(self, igdb_id: int) -> dict[str, Any] | None:
        ...
        query = f"""
        fields name, summary, involved_companies.company.name, involved_companies.developer, cover.image_id, artworks.image_id, screenshots.image_id, platforms.name, genres.name, first_release_date, total_rating;
        where id = {igdb_id};
        """
